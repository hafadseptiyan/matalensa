...
<div class="col-md-12 col-sm-12 col-xs-12">  
    <h3 class="text-center">Data Drone</h3><hr>
</div>
<div class="table-responsive">
    <table id="example1" class="table table-striped jambo_table bulk_action">
        ...
        <tbody>
            ...
            <td class="col-md-1 text-center">Rp.<?= $row->harga;?></td>
            <td class="col-md-3"><img src="<?php echo base_url('assets/admin/img/'.$row->gambar);?>" width="100%" class="img-responsive thumbnail"></td>
            ...
            <td class="col-md-1 text-center">
                <a href="<?php echo site_url('admin/edit/'.$row->id_produk); ?>"><button type="submit" class="btn btn-primary" style="margin-top: 10px;">
                 ...
                 <a style="margin-top: 10px;" href="<?php echo site_url('admin/delete/'.$row->id_produk); ?>"  onclick="return confirm('Apakah anda yakin menghapus data?')"><button type="submit" style="margin-top: 10px;" class="btn btn-danger" >
