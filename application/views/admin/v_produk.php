...
<div class="table-responsive">
    <table id="example1" class="table table-striped jambo_table bulk_action">
        ...
        <tbody>
            ...
            <td class="col-md-5"><?= $row->deskripsi;?></td>
            ...
            <td class="col-md-1 text-center">
                <a href="<?php echo site_url('admin/edit/'.$row->id_produk); ?>"><button type="submit" class="btn btn-primary" style="margin-top: 10px;">
                 ...
                 <a href="<?php echo site_url('admin/delete/'.$row->id_produk); ?>"  onclick="return confirm('Apakah anda yakin menghapus data?')"><button style="margin-top: 10px" type="submit" class="btn btn-danger" >
